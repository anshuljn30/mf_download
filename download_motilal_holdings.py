...
def download(dates):
    ...
    for d in dates:
        ...
        file = driver.find_elements_by_xpath('.//td[contains(text(), "' + year + '") and contains(text(), "' + month + '") and contains(text(), "Month")]')
        ...
        if file:
            file_link = file[0].find_element_by_xpath('.//parent::tr').find_element_by_xpath('.//a').get_attribute("href")
